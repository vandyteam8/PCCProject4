...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "file", source: "./t8-varun-evan-sam.pem", destination: "~/.ssh/t8-varun-evan-sam.pem"
  config.vm.provision "file", source: "./t8-varun-evan-sam.pem", destination: "/home/vagrant/t8-varun-evan-sam.pem"
  ...
  $script = <<-SCRIPT
     chmod go-rwx ~/.ssh/t8-varun-evan-sam.pem
     chmod go-rwx /home/vagrant/t8-varun-evan-sam.pem
  SCRIPT
  ...
  config.vm.provision "ansible_local" do |ansible|
    ...
    ansible.galaxy_command = "ansible-galaxy collection install openstack.cloud"
    ansible.galaxy_command = "ansible-galaxy collection install amazon.aws"
    ansible.galaxy_command = "ansible-galaxy collection install community.aws"
